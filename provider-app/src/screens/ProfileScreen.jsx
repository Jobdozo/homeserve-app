...
export default function ProfileScreen() {
  ...
  const menuItems = [
    ...
    { icon: "📄", label: "Documents & KYC", path: "/profile/documents", perm: "profile.edit", badge: verificationBadges[providerProfile.verificationStatus] },
    { icon: "🗓️", label: "Manage Availability", path: "/profile/availability", perm: "profile.edit" },
    { icon: "🔔", label: "Notification Settings", path: "/profile/notifications" },
    { icon: "🎁", label: "Refer a Friend", path: "/profile/refer" },
    { icon: "📢", label: "Advertisements", path: "/profile/ads", perm: "ads.manage" },
    { icon: "👥", label: "Staff Management", path: "/profile/staff", perm: ["staff.view", "staff.manage"] },
  ...
  return (
    <div className="flex flex-1 flex-col pb-4 lg:mx-auto lg:w-full lg:max-w-2xl lg:px-8 lg:pb-16 lg:pt-8">
      ...
      {staff && (
        <p className="mx-4 mt-3 rounded-xl bg-violet-50 px-3 py-2 text-[12px] text-violet-800 lg:mx-0">
